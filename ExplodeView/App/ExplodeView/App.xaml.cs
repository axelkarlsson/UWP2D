...
namespace ExplodeView
{
    ...
    sealed partial class App : Application
    {
        ...
        //
        private void UnityCommunication(string args)
        {
            ...
            if (args.Contains("Uri="))
            {
               ...
               UnityEngine.GameObject.FindObjectOfType<ExplodeManager>().UpdateObject(objectName);
            }
            else
            {
                UnityEngine.GameObject.FindObjectOfType<ExplodeManager>().UpdateObject(args);
            }
